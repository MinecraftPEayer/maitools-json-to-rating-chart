...
const BookmarkletPage = () => {
    ...
    return (
        <div className="bg-gray-800 w-screen h-screen p-6 text-white">
            <h1 className="text-4xl font-bold mb-4">maibot-bookmarklet</h1>

            <ol className="list-decimal ml-6 space-y-4">
                <li>
                    <strong>Create a bookmark:</strong> Add a new bookmark in
                    your browser.
                </li>
                <li>
                    <strong>Edit the bookmark:</strong> Open its edit dialog and
